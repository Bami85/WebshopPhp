...
<body>
    ...
    <header>
      ...
      <!-- ---------------------------------------------header--------------------------------------------------------- -->
       <!-- ---------------------------------------------ProductMacbookMain--------------------------------------------------------- -->
<main>
<section class="h1Cate"><h1>Macbooks</h1></section>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img class="bd-placeholder-img card-img-top" src="./productImages/Macbooks/macbook-air-m1-2020.pic1.jpg">
            <div class="card-body">
                <p class="card-text">MacBook Pro 2019 15,6"</p>
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img class="bd-placeholder-img card-img-top" src="./productImages/Macbooks/macbook-pro2019pic1.jpg">
            <div class="card-body">
                <p class="card-text">MacBook Pro 2019 15,6"</p>
              <div class="d-flex justify-content-between align-items-center">
                  <p>12,000:-</p>
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img class="bd-placeholder-img card-img-top" src="./productImages/Macbooks/macbook-pro2021Pic2.jpg">
            <div class="card-body">
              <p class="card-text">MacBook Pro 2021 16"</p>
              <div class="d-flex justify-content-between align-items-center">
                <p>17,000:-</p>
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary">Add to Cart</button>
