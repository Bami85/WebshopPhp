...
<body>
    ...
    <header>
      ...
      <!-- ---------------------------------------------header--------------------------------------------------------- -->
       <!-- ---------------------------------------------ProductIphonesMain--------------------------------------------------------- -->
<main>
<section class="h1Cate"><h1>Iphones</h1></section>
<a href="./products.html"><h3>return</p></h3></a>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img class="bd-placeholder-img card-img-top" src="./productImages/Iphones/Iphone11.128GB.pic1.jpg">
            <div class="card-body">
              <p class="card-text">Iphone 11 128GB</p>
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img class="bd-placeholder-img card-img-top" src="./productImages/Iphones/Iphone12Mini64GB.pic1.jpeg">
            <div class="card-body">
              <p class="card-text">Iphone 12 Mini 64GB</p>
              <div class="d-flex justify-content-between align-items-center">
                <p>6000:-</p>
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary">Add to Cart</button>
        ...
        <div class="col">
          <div class="card shadow-sm">
            <img class="bd-placeholder-img card-img-top" src="./productImages/Iphones/Iphone13ProMaxPic1.256GB.jpg">
            <div class="card-body">
              <p class="card-text">Iphone 13 Pro Max 256GB</p>
              <div class="d-flex justify-content-between align-items-center">
                <p>12,000:-</p>
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary">Add to Cart</button>
        ...
        <footer class="py-5">
          <div class="d-flex justify-content-between py-4 my-4 border-top">
            <ul class="list-unstyled d-flex">
              <li class="ms-3"><a class="link-white" href="mailto:webshop@gmail.com"><i class="lni lni-envelope"></i></a></li>
              <li class="ms-3"><a class="link-white" href="tel:070-000-000"><i class="lni lni-phone"></i></a></li>
            </ul>
            <ul class="list-unstyled d-flex">
